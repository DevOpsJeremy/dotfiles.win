...
$packageArgs = @{
  ...
  softwareName  = 'msstore' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  ...
  # MSI
  silentArgs    = "install --accept-package-agreements `"Microsoft Store Developer CLI`"" # ALLUSERS=1 DISABLEDESKTOPSHORTCUT=1 ADDDESKTOPICON=0 ADDSTARTMENU=0
