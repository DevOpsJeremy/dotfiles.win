...
$url        = 'https://www.voidtools.com/Everything-1.4.1.1032.x86.msi' # download url, HTTPS preferred
$url64      = 'https://www.voidtools.com/Everything-1.4.1.1032.x64.msi' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'everything' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
